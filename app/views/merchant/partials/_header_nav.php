<div class="merchant-header">
    <div class="center clearfix">
        ...
        <ul class="right clearfix">
            <?php if (!$merchant) { ?>
                <li class="left"><a href="<?= base_url(Merchant::MERCHANT_URL . '/login'); ?>"><i
                            class="icon-signin"></i>Sign in</a>
                </li>
                <li class="left"><a href="<?= base_url(Merchant::MERCHANT_URL . '/signup'); ?>"><i
                            class="icon-edit"></i>Sign up</a>
                </li>
            <?php } else { ?>
                <li class="left">
