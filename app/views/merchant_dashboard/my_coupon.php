                ...
                <div class="wrap-center">
                    ...
                    <?php
                        switch ($coupon->deal_status) {
                            ...
                            case 0:
                                ?>
                                <p><label>Deal status:</label> <span class="trans-state pending-trans">Pending</span>
                                </p>
                                <?php
                                break;
                            default:
                                ?>
                                    <p><label>Deal status:</label> <span
                                            class="trans-state cancelled-trans">Completed</span></p>
                                <?php
                        }
                    ?>
                            ...
                            if (property_exists($coupon, 'coupon_medias') && !empty($coupon->coupon_medias)) {
                                foreach ($coupon->coupon_medias as $media) {
                                    ...
                                    <li style="display: inline-block">
                                        <a href="">
                                            <img height="80" width="80" src="<?= base_url($media->media_url) ?>"
                                                 alt="Image Alternative text" title="cascada"/>
                                        </a>
                                    </li>
                                <?php
                                }
