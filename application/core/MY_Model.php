...
class MY_Model extends CI_Model {
    ...
    public function search_many_by() {
        $where = func_get_args();
    ...
    public function count_likes_by() {
    ...
    protected function _set_like($params) {
        if (count($params) == 1 && is_array($params[0])) {
            ...
            $this->_database->like($this->search_column, $params[0]);
        } else if (count($params) == 2) {
            $this->_database->like($params[0], $params[1]);
        } else if (count($params) == 3) {
            $this->_database->like($params[0], $params[1], $params[2]);
        } else {
            $this->_database->like($params[0], $params[1]);
        }
    }
