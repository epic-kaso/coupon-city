 ...
 */
$config['site_title'] = "CouponcCity.com.ng";       // Site Title, example.com
$config['admin_email'] = "admin@couponcity.com.ng"; // Admin Email, admin@example.com
...
/*
  ...
  | Default: auth/
 */
$config['email_templates'] = 'layouts/email/';
